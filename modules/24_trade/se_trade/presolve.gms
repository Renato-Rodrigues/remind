...
*** - H2 and seliqsyn maximum exporting prices = linear decrease from 15$/kg by 2020 to 10$/kg by 2050 and onward
*** - seliqbio maximum exporting prices =   linear decrease from 70 US$2005/GJ by 2020 to 50$/kg by 2050 and onward
pm_XPortsPrice(t,regi,"seh2")     = min( max(15 + (t.val-2020)*(10-15)/(2050-2020),10) / sm_h2kg_2_h2kWh * sm_TWa_2_kWh / sm_trillion_2_non, pm_XPortsPrice(t,regi,"seh2"));
pm_XPortsPrice(t,regi,"seliqsyn") = min( max(15 + (t.val-2020)*(10-15)/(2050-2020),10) / sm_h2kg_2_h2kWh * sm_TWa_2_kWh / sm_trillion_2_non, pm_XPortsPrice(t,regi,"seliqsyn"));
pm_XPortsPrice(t,regi,"seliqbio") = min( max(70 + (t.val-2020)*(50-70)/(2050-2020),50) / sm_trillion_2_non * sm_GJ_2_TWa, pm_XPortsPrice(t,regi,"seliqbio"));
