...
display "Reasons for non-convergence in this iteration (if not yet converged)";
	 ...
	 loop(convMessage80$(p80_messageShow(convMessage80)),
        ...
        if(sameas(convMessage80, "pfm"),
          ...
          display "#### Check p45_pfmDelta against cm_pfmConvTol, and pm_pfmInfesCode (1 price explosion, 2 budget-iteration divergence, 3 missing price bound).";
